...
lo_dests = [destination + i + '/' for i in ['Pack_G100small', 'Pack_G100medium', 'Pack_G100large',
                               ...
                               'Pack_G5small', 'Pack_G5medium', 'Pack_G5large']]
...
note_nums = {'Pack_G100small' : ['0', '56', '57', '58'],
             ...
             'Pack_G50small' : ['46', '47', '48'],
             'Pack_G50medium' : ['49', '50'],
             'Pack_G50large' : ['51', '52', '53', '54', '55'],
             'Pack_G20small' : ['33', '34', '35'],
             'Pack_G20medium' : ['36', '37', '38'],
             'Pack_G20large' : ['39', '40', '41', '42', '43', '44', '45'],
             'Pack_G10small' : ['21', '22', '23'],
             'Pack_G10medium' : ['24', '25', '26'],
             'Pack_G10large': ['27', '28', '29', '30', '31'],
             'Pack_G5small' : ['11', '12'],
             'Pack_G5medium' : ['13', '14', '15', '16'],
             'Pack_G5large': ['17', '18', '19'],
             }
assert len(note_nums.keys()) == len(lo_dests)
...
for dest in lo_dests:
    ...
    'Circular 1' : dest.split('/')[-2].replace('PACK_', '').replace('Pack_', ''),
    'Circular 2' : np.nan,
    'Parent Note' : np.nan,
    'OriginalLat' : np.nan,
    'OriginalLng' : np.nan,
