...
def main():
    ...
    for ds in ['note_families_front', 'note_families_back', 'note_families_seal', 'note_styles', 'cars']:
        for model_name in ['swept-pine-110', 'dark-surf-14', 'major-fire-14']:
            for generator in ['validation', 'test']:
                ...
                for idx, x in enumerate(tSNE_plots):
                    ...
                    plt.title(f"{model_name} {ds} - {generator}, epoch {int(idx*5)}")
